...
public class Main {
    public static void main(String[] args) {
        ...
        manager.uploadPhoto(new Photo("1", "pyramids.jpg", LocalDate.of(2023, 3, 10),
                new Location("Giza",29.9773,31.1325,20), Set.of("pyramids", "history", "egypt", "tourism")));

        manager.uploadPhoto(new Photo("2", "nile.jpg", LocalDate.of(2023, 4, 22),
                new Location("Cairo",29.9773,31.1325,20), Set.of("nile", "river", "sunset", "egypt")));

        manager.uploadPhoto(new Photo("3", "mosque.jpg", LocalDate.of(2023, 4, 22),
                new Location("Cairo",29.9773,31.1325,20), Set.of("mosque", "islamic", "architecture", "egypt")));

        manager.uploadPhoto(new Photo("4", "museum.jpg", LocalDate.of(2023, 5, 15),
                new Location("Cairo",29.9773,31.1325,20), Set.of("museum", "antiquities", "egypt", "pharaohs")));
